			...
			<div>
				...
				<div className="container">
					<div id="edit">
						...
						<Link to='/set/position' className='msg-details' >{this.state.position}</Link>
						<h3 className='msg-title'>工作地点</h3>
						<Link to='/set/city' className='msg-details' >{this.state.city}</Link>
						<h3 className='msg-title'>期望薪水</h3>
						<Link to='/set/salary' className='msg-details' >{this.state.salary}</Link>
						<h3 className='msg-title'>公司规模</h3>
						<Link to='/set/stage' className='msg-details' >{this.state.stage}</Link>
					</div>
